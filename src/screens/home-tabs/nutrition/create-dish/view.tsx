  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        <View style={styles.box}>
          ...
          <View style={styles.col3}>
            <Text style={styles.input}>{calories || ""}</Text>
          </View>
        </View>
        <View style={styles.box}>
          <Text style={styles.rowTitle}>{"Б"}</Text>
          <View style={styles.col1}>
            <Text style={styles.input}>{protein || ""}</Text>
          </View>
        </View>
        <View style={styles.box}>
          <Text style={styles.rowTitle}>{"Ж"}</Text>
          <View style={styles.col1}>
            <Text style={styles.input}>{oil || ""}</Text>
          </View>
        </View>
        <View style={styles.box}>
          <Text style={styles.rowTitle}>{"У"}</Text>
          <View style={styles.col1}>
            <Text style={styles.input}>{carb || ""}</Text>
          </View>
        </View>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.title}>{"Выберите категорию нового блюда"}</Text>
